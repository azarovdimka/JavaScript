...
let i = "Сегодня "+Day+" "+fMonth+" "+Year+" года, "+fWeekDay+", "+fHour+" "+fMin+" "+fSec+".";



alert("Сегодня "+Day+" "+fMonth+" "+Year+" года, "+fWeekDay+", "+fHour+" "+fMin+" "+fSec+". Часы работают. \n" + "Как тикают часы - можно наблюдать в консоли, нажав F12.");

setInterval('console.log(console.log(i))', 1000);